    ...
    <body>
        ...
        <section id="hero">
            ...
            <div class="row">
                ...
                <div>
                    <h1>Empleos GADBENI</h1>
                    <h2>Plataforma Departamental de Asistencia y Gestión de Solicitudes de Empleo</h2>
                    <a href="#about" class="btn-get-started scrollto">Busco empleo</a>
                    <a href="#about" class="btn-get-started scrollto">Busco empleados</a>
                </div>
                </div>
